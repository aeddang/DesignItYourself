...
struct InfinityScrollView<Content>: PageView, InfinityScrollViewProtocol where Content: View {
    ...
    init(
        ...
        usePullToReflash:Bool = false,
        bgColor:Color = Color.transparent.clear,
            ...
            && self.header == nil
        {
            ...
            if !self.isList {
                ScrollLazeStack(
                    ...
                    usePullToReflash: self.usePullToReflash,
