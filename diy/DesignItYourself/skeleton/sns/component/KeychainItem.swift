...
struct KeychainItem {
    // MARK: Types
    static let SERVICE_ID = "com.podo.globe"
    static let USER_IDENTIFIER = "userIdentifier"
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: Self.SERVICE_ID, account: Self.USER_IDENTIFIER).readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: Self.SERVICE_ID, account: Self.USER_IDENTIFIER).deleteItem()
        } catch {
